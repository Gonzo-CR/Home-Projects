...
public class TestFrame extends JFrame
{
	...
	public TestFrame()
	{
		...
		scrollPane_LehrerTabelle.setBounds(19, 179, 585, 260);
		...
		lblEingabe.setBounds(19, 107, 135, 17);
		...
		tfSuchfeldLehrer.setBounds(19, 130, 135, 23);
		...
		MB_Filter.setBounds(180, 118, 97, 28);
		...
		chbxAllesMarkieren.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				mnFilter.doClick();
				ChbxGroup();
				System.out.println(faecherliste.get(0).getBezeichnung());
		...
		JLabel lblAlleSuchen = new JLabel("Alle Suchen");
		lblAlleSuchen.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				zeigeAlleLehrer();
			}
		});
		lblAlleSuchen.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
		lblAlleSuchen.setHorizontalAlignment(SwingConstants.CENTER);
		lblAlleSuchen.setIcon(new ImageIcon(Such_Fenster.class.getResource("/package_Icons/searchAllIcon24(Black).png")));
		lblAlleSuchen.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		lblAlleSuchen.setBounds(295, 112, 117, 39);
		panel_GesLehrerSuche.add(lblAlleSuchen);
		
		JLabel label = new JLabel("Alle Suchen");
		...
		label.setIcon(new ImageIcon(Such_Fenster.class.getResource("/package_Icons/searchSingleIconUnfilled24(Black).png")));
		label.setHorizontalAlignment(SwingConstants.CENTER);
		label.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		label.setBounds(452, 112, 117, 39);
		panel_GesLehrerSuche.add(label);
		
		JMenuBar menuBar_1 = new JMenuBar();
		menuBar_1.setBounds(315, 18, 97, 21);
		...
		mnNewMenu.addMenuListener(new MenuListener() {
			...
			public void menuSelected(MenuEvent e) {
				einzelLehrerSuche();
//				checkAlleChbx(1);
				System.out.println(chbxFachAnzeigen_1.isSelected());
			}
		});
...
//		model = (DefaultTableModel)table_Lehrer.getModel();
		...
		for(int i = 0; i < chbxListe.size(); i++)
		{
			...
			if(cbMI.isSelected() == true)
			{
				...
				{
					System.out.println("HAt wohl nicht geklappt spast!");
				}
